                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="news-feed-area">
                            <div class="news-feed news-feed-form">
                                <h3 class="news-feed-title">Posting Project baru</h3>

                               <form method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" name="title" class="form-control" placeholder="Judul..."><br>
            <input type="text" name="excerpt" value="" class="form-control" placeholder="Bayaran"><br>
                                    <div class="form-group">
                                        <textarea name="body" class="form-control" placeholder="Deskripsi..."></textarea>
                                    </div>
