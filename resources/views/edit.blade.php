        ...
        <div class="main-content-wrapper d-flex flex-column">
                                ...
                                <ul class="profile-statistics">
                                    <li>
                                        <a href="#">
                                            ...
                                            <span class="item-text">Discussion</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
            ...
            @csrf
                                    <div class="form-group">
                                                <input type="text" name="title" class="form-control" placeholder="Judul..." value="{{$post->title}}">
                                                <input type="hidden" name="excerpt" value="1" class="form-control" placeholder="Judul...">
                                        <textarea name="body" class="form-control" placeholder="Write something here...">{{$post->body}}</textarea>
                                    </div>
                                    <ul class="button-group d-flex justify-content-between align-items-center">
                                        <li class="photo-btn">
                                            <input class="" type="file" name="image" id="" required>
                                        </li>
                                        <li class="post-btn">
