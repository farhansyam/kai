    ...
    <body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="search-box m-auto">
                                <form action="{{url('project-cari')}}" method="GET">
                                    <input type="text" name="cari"  value="{{ old('cari') }}" class="input-search" placeholder="Search Project...">
        ...
        <div class="content-page-box-area">
            ...
            <div class="marketplace-inner-box-style d-flex justify-content-between align-items-center">
                ...
                <a href="{{route('project.create')}}"><button class="btn btn-success">+ Project</button></a>
            </div>
               ...
               <div class="col-lg-4  col-sm-6">
                   <div class="single-marketplace-card">
                       <div class="marketplace-image">
                           <a href="{{route('project.show',$post->id)}}"><img src="{{asset('images/'.$post->image)}}" alt="image"></a>
                        ...
                        <div class="marketplace-content">
                            ...
                            <div class="price">Rp.{{$post->excerpt}}</div>
                        </div>
                        <br>
                                            @if (auth()->user()->name == $post->user->name)
                                            <form id="delete-post{{ $post->id }}" class="deletion-form"
                                                action="{{ route('project.destroy', $post->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a class="btn btn-warning btn-sm" href="{{ route('project.edit', $post->id) }}">
