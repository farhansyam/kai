            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="products-details-content">
                        <h3>{{$posts->title}}</h3>
                        <div class="price">Rp. {{$posts->excerpt}}</div>
                        <ul class="list">
                            <li><span>Date Line</span> {{$posts->created_at}}</li>
                        </ul>
                        <h4>Details:</h4>
                        <p>{{$posts->body}}</p>

                        <div class="seller-information">
                            <h5>Project Posted By</h5>

                            <div class="information-content">
                                <img src="assets/images/user/farhan.png" class="rounded-circle" alt="image">
                                <h6>{{$posts->user->name}}</h6>
                            </div>
