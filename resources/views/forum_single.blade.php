            ...
            <div class="navbar-area">
                ...
                <div class="main-navbar">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a href="{{route('forum')}}" class="navbar-brand d-flex align-items-center">
                            <img src="../assets/images/2.png" alt="image" width="100px">
                        </a>
                                    ...
                                    <div class="dropdown profile-nav-item">
                                        <a href="#" class="dropdown-bs-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <div class="menu-profile">
                                                <img src="../assets/images/user/user-7.jpg" class="rounded-circle" alt="image">
                                        ...
                                        <div class="dropdown profile-nav-item">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <ul class="profile-body">
                                                    ...
                                                    <li><i class="flaticon-logout"></i> <a href="{{route('forum')}}">Logout</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <aside class="widget-area">
                          <div class="widget widget-view-profile">
                                <div class="profile-box d-flex justify-content-between align-items-center">
                                    <a href="my-profile.html"><img src=" {{asset('images/user/farhan.png')}}" alt="image"></a>
                                    <div class="text ms-2">
                        ...
                        <div class="news-feed-area">
                               ...
                               <div class="news-feed news-feed-post">
                                <div class="post-header d-flex justify-content-between align-items-center">
                                    <div class="image">
                                        <a href="my-profile.html"><img src=" ../assets/images/user/farhan.png" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="info ms-3">
                                        <span class="name"><a href="my-profile.html">{{$forum->user->name}}</a></span>
                                ...
                                <div class="post-body">
                                    ...
                                    <ul class="post-meta-wrap d-flex align-items-center">
                                        @if (auth()->user()->name == $forum->user->name)
                                              <a class="btn btn-warning btn-sm" href="{{ route('forum.edit', $forum->id) }}">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>&nbsp;
                                            <form id="delete-post{{ $forum->id }}" class="deletion-form"
                                        action="{{ route('posts.destroy', $forum->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
...
<script>
    ...
    */
    ...
    s.src = 'https://kai-6.disqus.com/embed.js';
